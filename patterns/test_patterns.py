...
def cycle_value_in_cosine(branch,branch_vine,vine_pixel,t):
    ...
    saturation = 0.7
    period = 4
    value = 250 * library.cycle_in_cosine(branch_vine,t,period)
...
def cycle_value_out_cosine(branch,branch_vine,vine_pixel,t):
	...
	saturation = 0.7
	period = 4
	value = 250 * library.cycle_out_cosine(branch_vine,t,period)
	return color_utils.hsv_to_rgb(hue,saturation,value)
...
def cycle_value_out(branch,branch_vine,pixel,t):
	...
	saturation = 0.7
	period = 4
	value = 250 * library.cycle_out_continuous(branch_vine,t,period)
	return color_utils.hsv_to_rgb(hue,saturation,value)
...
def cycle_value_in(branch,branch_vine,pixel,t):
	...
	saturation = 0.7
	period = 4
	value = 250 * library.cycle_in_continuous(branch_vine,t,period)
	return color_utils.hsv_to_rgb(hue,saturation,value)
...
def cycle_value_around(branch,branch_vine,pixel,t):
	...
	saturation = 0.7
	period = 4
	value = 250 * library.cycle_clockwise_continuous(branch,t,period)
	return color_utils.hsv_to_rgb(hue,saturation,value)
...
def cycle_value_up(branch,branch_vine,pixel,t):
	...
	saturation = 0.7
	period = 4
	value = 250 * library.cycle_up_continuous(pixel,t,period)
	return color_utils.hsv_to_rgb(hue,saturation,value)
...
def cycle_value_down(branch,branch_vine,pixel,t):
	...
	saturation = 0.7
	period = 4
	value = 250 * library.cycle_down_continuous(pixel,t,period)
	return color_utils.hsv_to_rgb(hue,saturation,value)
...
def crazy_spiral_down(branch,branch_vine,vine_pixel,t):
    ...
    value_period = 4
    value = 250 * library.cycle_clockwise_cosine(branch - branch_vine - vine_pixel,t,value_period)
    return color_utils.hsv_to_rgb(hue,saturation,value)
...
class transition_to_rain(blend_transition):
    ...
    def get_pixel_color(self, branch, branch_vine, vine_pixel, t):
        ...
        # else:
        #     return factor1 * a1, factor1 * a2, factor1 * a3
...
spider_function = spider_instance.get_pixel_color
...
transitions[2] = transition_to_rain(active_patterns[2], rain)
